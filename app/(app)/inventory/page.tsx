      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <Button
            size="sm"
            variant="outline"
            onClick={() => router.push("/inventory/return")}
          >
        ...
        <Card className="border-orange-400 bg-orange-50">
          ...
          <CardContent>
            <p className="text-sm text-orange-700">
              The following {lowStockItems.length} item(s) are at or below the
              minimum stock level:
            </p>
                  ...
                  filteredItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {isLowStock && (
                            <AlertTriangle className="h-4 w-4 inline-block mr-1 text-orange-500" />
                          )}
                          {item.quantity}
                        </TableCell>
                        ...
                        <TableCell className="text-center">
                          <div className="flex items-center justify-center space-x-1">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                router.push(`/inventory/history/${item.id}`)
                              }
                            >
